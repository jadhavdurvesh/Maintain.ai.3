...
export default function AIAssistant() {
  ...
  const [useOnline, setUseOnline] = useState(saved?.useOnline ?? true)
  const [problem, setProblem] = useState(saved?.problem || '')
  const [answers, setAnswers] = useState(saved?.answers || [])
  const [pendingQuestions, setPendingQuestions] = useState(saved?.pendingQuestions || [])
      ...
      <div className="panel section-gap">
        ...
        <div className="panel-body" style={{ display: 'flex', gap: 16, flexWrap: 'wrap', alignItems: 'flex-end' }}>
          ...
          <label style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
            ...
            Use Gemini (offline fallback if unavailable)
          </label>
        </div>
      </div>
        ...
        <div className="panel section-gap">
          <form onSubmit={submitProblem}>
            ...
            <div className="panel-body">
              <textarea required value={problem} onChange={(e) => setProblem(e.target.value)} placeholder="e.g. My motor is overheating and making noise." />
      ...
      {result && (
        <div className="panel">
          ...
          <div className="panel-body">
            ...
            {answers.length > 0 && (
              <div style={{ marginBottom: 14 }}>
                <div style={{ color: 'var(--text-faint)', fontSize: 12, marginBottom: 6 }}>TECHNICIAN ANSWERS</div>
            ...
            {pendingQuestions.length > 0 ? (
              <form onSubmit={submitAnswer}>
                <div style={{ color: 'var(--text-faint)', fontSize: 12, marginBottom: 6 }}>NEXT DIAGNOSTIC QUESTION</div>
              ...
              <>
                ...
                <div className="field">
                  <label>What did the technician actually find? (optional)</label>
                  <div style={{ display: 'flex', gap: 8 }}>
